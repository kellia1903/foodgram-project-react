Прошу прощения:
Знаю, что не работает фильтрация... меня вымотала настройка на удаленном сервере, и то еще до workflow не добрался
если есть возможность, можно, пожалуйста, подсказки по фильтрации.
